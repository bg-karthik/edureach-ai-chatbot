        ...
        <div className="p-6">
          {status === "form" && (
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                ...
                aria-label="Call now"
                title="Call now"
                className="w-full bg-maroon text-white py-3 rounded-lg font-semibold hover:bg-maroon-dark"
              >
                📞 Call Me Now
              </button>
            </form>
          ...
          {status === "error" && (
            <div className="text-center py-10">
              ...
              <button
                onClick={reset}
                className="bg-maroon text-white px-5 py-2 rounded-lg text-sm hover:bg-maroon-dark"
              >
                Try Again
              </button>
            </div>
